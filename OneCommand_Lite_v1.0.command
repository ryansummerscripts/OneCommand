...
function macos_preferences() {
    ...
    declare -a preference_commands=(
        ...
        # Or group header: "GROUP|<Title>|<Optional Subtext>"
        "GROUP|💬 [Messages]|"
        "🚫 Disable Send Read Receipts 1 of 2|com.apple.imagent|Setting.EnableReadReceipts|false|true|true|true|Screens unknown senders"
        "🚫 Disable Send Read Receipts 2 of 2|com.apple.imagent|Setting.GlobalReadReceiptsVersionID|2|1|1|1|Screens unknown senders"
    ...
    while true; do
        ...
        if [[ -z "$TERMINAL_ACCESS_WARNING_SHOWN" ]]; then
            echo "--------------------------------------------------------------------------------"
            echo "ℹ️  ${BO}About:${NC}"
            echo "This sub-menu allows you to change over 175+ macOS preferences as well as"
...
EOF
                    ...
                    echo "- ${GR}Added${NC} over 93+ more customizations to ⚙️  MacOS Preferences ${BO}${GY}(168 in total)${NC}"
                    ...
                    echo "- ${GR}Added${NC} 'User Account Details' as an option to menu item: 12) ℹ️  System Information"
                    echo
                    echo "${BO}Public Release v1.0 - 09/15-2025${NC}"
                    echo "- ${GR}Added${NC} 12 new ⚙️  MacOS Preferences for ${BL}macOS Tahoe${NC} ${BO}${GY}(180 in total)${NC}"
                    break
                    ;;
                3)
                    # Check for updates
